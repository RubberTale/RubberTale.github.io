...
* **华东地区**：依托扬子石化、齐鲁石化、镇海炼化及新兴的民营大炼化（如浙江石化），是最大的生产与消费基地。山东省作为轮胎制造大省，对合成橡胶的就地消化能力极强。  
...
graph TB
    %% 定义样式
    classDef regionNW fill:#e3f2fd,stroke:#1565c0,stroke-width:2px,color:#0d47a1;
    classDef regionNE fill:#fbe9e7,stroke:#d84315,stroke-width:2px,color:#bf360c;
    classDef regionEC fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px,color:#1b5e20;
    classDef techNode fill:#fff9c4,stroke:#fbc02d,stroke-width:3px,stroke-dasharray: 5 5;
    classDef tireNode fill:#e0e0e0,stroke:#616161,stroke-width:2px;
    classDef flowEdge stroke-width:3px,stroke:#546e7a,fill:none;
    ...
    direction TB
        ...
        %% 华东板块
        subgraph EC [华东板块 Shandong/Jiangsu/Zhejiang]
            direction TB
            C1[最大的生产与消费基地]
            subgraph Producers [主要炼化企业]
                C2(扬子石化 / 齐鲁石化 / 镇海炼化)
                C3(民营大炼化: 浙江石化)
            end
            subgraph Consumer [核心消费端]
                C4{{山东省: 轮胎制造大省}}:::tireNode
            end
            C1 --- Producers
            Producers ==>|极强就地消化能力| C4
        end
        class EC regionEC

    %% 定义流向关系
    NE =================>|北材南下流向华东/华南| EC:::flowEdge
    N_Rail =================>|地理位置偏但辐射全国| EC:::flowEdge
