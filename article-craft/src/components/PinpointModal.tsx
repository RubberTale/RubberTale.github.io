...
const QUICK_TAGS = [
  ...
  { name: '炼字推敲', color: 'bg-amber-500/20 text-amber-300 border-amber-500/30' },
  { name: '意境升华', color: 'bg-purple-500/20 text-purple-300 border-purple-500/30' },
  { name: '意象淬炼', color: 'bg-teal-500/20 text-teal-300 border-teal-500/30' },
  { name: '对仗与格律', color: 'bg-orange-500/20 text-orange-300 border-orange-500/30' },
  ...
  { name: '明确职责', color: 'bg-violet-500/20 text-violet-300 border-violet-500/30' },
  { name: '情节推进', color: 'bg-yellow-500/20 text-yellow-300 border-yellow-500/30' },
